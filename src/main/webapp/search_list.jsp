    ...
    <div id="main">
        <div class="container">
            ...
            <span class="search_title">
                <b>ishare > ${search_msg} > </b><font color="red">搜索结果</font>
            </span>
            <div class="row">
                ...
                <ul class="pagination">
                    ...
                    <c:if test="${pb.currentPage != 1}">
                        <li>
                            ...
                            <a href="${pageContext.request.contextPath}/course?method=pageQuery&currentPage=${pb.currentPage - 1}&rows=4&csName=${search_msg}">
                    ...
                    <c:forEach begin="${begin}" end="${end}" var="i">
                        ...
                        <c:if test="${pb.currentPage == i}">
                            <li class="active">
                                <a href="${pageContext.request.contextPath}/course?method=pageQuery&currentPage=${i}&rows=4&csName=${search_msg}">
                                        ${i}
                                </a>
                            </li>
                        </c:if>
                    ...
                    <c:if test="${pb.currentPage != pb.totalPage}">
                        <li>
                            ...
                            <a href="${pageContext.request.contextPath}/course?method=pageQuery&currentPage=${pb.currentPage + 1}&rows=4&csName=${search_msg}" aria-label="Next">
